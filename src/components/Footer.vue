    ...
    <v-card flat tile class="black white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="gey--text pt-0">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam
            commodi quos deserunt distinctio vel, officia, veritatis obcaecati
            est quia corrupti ullam incidunt, accusantium sint minima facilis
            exercitationem at. Maiores, dolorum!
          </v-card-text>
