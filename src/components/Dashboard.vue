<template>
    <v-container fluid>
        <v-card color="#3853D8" height="150px" tile flat class="d-flex align-center justify-center" dark>
            <v-row>
                <v-col cols="12" sm="12">
                    <h4 class="text-center">MENS'S LIFESTYLE SHOES</h4>
                </v-col>
                <v-col cols="12" sm="12">
        ...
        <v-card tile class="mx-16 mt-n10 card1" color="white">
                ...
                <v-col cols="12" sm="8" class="pr-0">
                    <v-card height="250px" tile flat color="#3890D8">
                        <v-row>
                            ...
                            <v-col cols="12" sm="8">
                                <v-img src="bike.png" max-height="400" max-width="400" contain class="mt-m6"></v-img>
                            </v-col>
                        </v-row>
                    </v-card>
                </v-col>
                    ...
                    <v-card height="250px" tile flat color="#6857E1">
                        <v-row>
                            <v-col cols="12" sm="6" class="pl-8 pt-5">
                                ...
                                <v-btn rounded color="#B375E7" dark class="withoutupercase px-8 mt-3">
                                    More Info
                                </v-btn>
                            </v-col>
                            <v-col cols="12" sm="6">
            ...
            <v-row>
                ...
                <v-col cols="9" class="mt-n3">
                    <v-row>
                        <v-col class="12" sm="4" v-for="(clothe,i) in clothes" :key="i" :class="clothe.class">
                            <v-hover v-slot:default="{hover}">
                                <v-card height="300" align="center" flat outlined tile>
                                    ...
                                    <v-expand-transition>
                                        <div v-if="hover" class="d-flex transition-fast-in-fast-out blue v-card--reveal display white--text" style="height: 100%;">
